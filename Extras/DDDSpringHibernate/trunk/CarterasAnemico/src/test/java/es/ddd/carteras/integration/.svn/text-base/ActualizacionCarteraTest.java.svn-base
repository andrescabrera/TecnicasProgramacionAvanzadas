...
import es.ddd.carteras.modelo.ServicioActualizacionCartera;
...
public class ActualizacionCarteraTest {
    ...
    private Accion Yahoo = new Accion("Yahoo", 30l);
    private Accion Google = new Accion("Google", 35l);
    ...
    public void actualizacion_de_carteras() {
        ...
        ServicioActualizacionCartera actualizadorCartera = new ServicioActualizacionCartera(reuters, eurobits, yoodle);
        actualizadorCartera.actualizar(tecnologicas);
